...
const Project = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      desc: "This is the Blogs website  users can post view edit delete their blogs I have used material ui react redux firebase  with the help of firebase i have integrated authantication and storing user data to the firebase database ",
    },
    {
      id: 4,
      name: "Netflix Clone",
      ...
      desc: "This website is the clone to the Netflix  where we can only view top movies, tranding movies and allot more I have build this website uisng react material ui axios and firebase ",
    },
    {
      id: 5,
      name: "Wheather App",
      ...
      desc: "This website gives us wheather temp of the searched city this website i have created using vanila javascript html and css",
    },
    {
      id: 6,
      name: "Recipe App",
